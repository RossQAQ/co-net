...
constexpr __kernel_timespec operator""_s(ull second) {
    return { static_cast<long long>(second), 0 };
}

constexpr __kernel_timespec operator""_ms(ull ms) {
...
constexpr __kernel_timespec operator""_us(ull us) {
...
constexpr __kernel_timespec operator""_ns(ull ns) {
